export const LABELS = {
  page: {
    ...
    tabPickups: "Abholungen",
    tabActiveShipments: "Aktive Sendungen",
  },

  pickup: {
    title: "Abholungen",
    emptyTitle: "Keine offenen Abholungen",
    emptyDescription: "Alle Abholbestellungen sind abgeschlossen.",
    loading: "Abholungen werden geladen...",
    errorLoad: "Abholungen konnten nicht geladen werden. Bitte versuchen Sie es erneut.",
    statusReceived: "Eingegangen",
    statusReady: "Bereit zur Abholung",
    markReadyButton: "Bereit markieren",
    markReadyPending: "Wird vorbereitet...",
    markPickedUpButton: "Als abgeholt markieren",
    markPickedUpPending: "Wird bestätigt...",
    confirmPickupTitle: "Abholung bestätigen?",
    confirmPickupBody:
      "Diese Aktion kann nicht rückgängig gemacht werden. Der Kunde erhält eine Bestätigungs-E-Mail.",
    confirmPickupConfirm: "Bestätigen",
    confirmPickupCancel: "Abbrechen",
    toastReadySuccess: "Bestellung als bereit markiert. Kunde wurde benachrichtigt.",
    toastReadyError: "Bestellung konnte nicht als bereit markiert werden.",
