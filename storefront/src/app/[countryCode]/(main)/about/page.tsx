...
const storySections: { title: string; body: string }[] = [
  {
      ...
      <section className="py-16 small:py-24 bg-white">
        <div className="content-container">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="small:hidden space-y-10">
                    ...
                    return (
                      <div key={block.title} className="relative">
                        ...
                        <div className="grid grid-cols-2 gap-0">
                          {/* Linke Spalte */}
                          <div className={`pr-12 ${isLeft ? '' : 'invisible'}`}>
                            {isLeft && (
                          ...
                          {/* Rechte Spalte */}
                          <div className={`pl-12 ${!isLeft ? '' : 'invisible'}`}>
                            {!isLeft && (
