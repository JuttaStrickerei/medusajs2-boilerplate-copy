...
const MyWidget = ({ data }: DetailWidgetProps) => {
...
- **Product widgets:** Go to Products → Select a product → Your widget appears in the zone you configured
...
- Look for your custom page in the admin sidebar/navigation
