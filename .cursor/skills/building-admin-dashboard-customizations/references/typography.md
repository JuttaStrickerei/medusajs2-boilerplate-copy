...
```tsx
<div className="p-4 rounded-md shadow-elevation-card-rest bg-ui-bg-component">
  <Text size="small" leading="compact" weight="plus">
...
| Use Case | Pattern |
|----------|---------|
| Section headings | `<Text size="small" leading="compact" weight="plus">` |
| Primary text | `<Text size="small" leading="compact" weight="plus">` |
| Labels | `<Text size="small" leading="compact" weight="plus">` |
| Descriptions | `<Text size="small" leading="compact" className="text-ui-fg-subtle">` |
| Helper text | `<Text size="small" leading="compact" className="text-ui-fg-subtle">` |
| Metadata | `<Text size="small" leading="compact" className="text-ui-fg-subtle">` |
| Errors | `<Text size="small" leading="compact" className="text-ui-fg-error">` |
| Empty states | `<Text size="small" leading="compact" className="text-ui-fg-subtle">` |
