...
- `type-request-schema` - Pass Zod inferred type to `MedusaRequest` when using `req.validatedBody`
...
**Type Safety:**
- [ ] Forgetting `MedusaRequest` type argument
...
- Type mismatches (e.g., missing `MedusaRequest` type argument)
